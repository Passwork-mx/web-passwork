...
if ( ! function_exists( 'coworking_tribe_events_get_css' ) ) {
	add_filter( 'coworking_filter_get_css', 'coworking_tribe_events_get_css', 10, 2 );
	function coworking_tribe_events_get_css( $css, $args ) {
