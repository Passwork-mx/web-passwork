...
WordPress version: required at least 5.0, tested up to 6.0.1
...
Theme documentation is available on https://coworking.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Coworking is Fontello.
