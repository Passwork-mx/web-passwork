...
if ( ! function_exists( 'coworking_woocommerce_get_css' ) ) {
	add_filter( 'coworking_filter_get_css', 'coworking_woocommerce_get_css', 10, 2 );
	function coworking_woocommerce_get_css( $css, $args ) {
...
$fdir = coworking_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
